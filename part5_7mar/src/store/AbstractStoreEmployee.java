...
public abstract class AbstractStoreEmployee implements Employee, Store {
    ...
    /**
     * Menghitung bonus berdasarkan persentase penjualan.
     *
     * @return Jumlah bonus yang diterima oleh karyawan.
     */
    public abstract double calculateSalesBonus();

    /**
     * Menghitung jumlah kerugian untuk toko berdasarkan penjualan karyawan.
     *
     * @return Jumlah kerugian toko.
     */
    public abstract double calculateStoreLoss();

    /**
     * Menghitung total gaji yang diterima oleh karyawan, termasuk bonus penjualan.
     *
